...
function createInstance(defaultConfig) {
    ...
    // axios实际上是指向了bind函数的返回值，即wrap函数，那么axios执行即wrap函数执行，会实际执行Axios.prototype.request方法且执行时的this指向context
    ...
    return instance;// 此时instance是函数，因为它的作用同request；他还是对象，可以调方法使用。
}
// axios.interceptors
